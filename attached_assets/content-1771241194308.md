[Skip to main content](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign#__docusaurus_skipToContent_fallback)

On this page

This article provides how to create campaigns for any channel. The process for creating a campaign remains same for all channels. However, certain steps change in _Step 2: Message template_ depending on the channel and variables used in the selected template.

## 1\. Prerequisites [​](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign\#1-prerequisites "Direct link to 1. Prerequisites")
...
## 2\. Create Outbound campaign [​](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign\#2-create-outbound-campaign "Direct link to 2. Create Outbound campaign")
...
4. Select your preferred **Message template** using the respective radio button. For more details, see [Templates overview](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/templates/overview).
...
![](https://i.imgur.com/0Dl7IUi.gif)
   - For SMS, choose the user's phone number variable and map the variables used in the template to the user property variable.For more details, [see here](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign#31-sms-campaign).
   - For Email, choose the variable that contains email Id, select the sender ID (email ID), and map the user variables used in the template. For more details, [see here](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign#32-email-campaign).
   - For WhatsApp or Viber, choose the variable containing WhatsApp number, sender ID, and map the user variables used in the template. For more details, [see here](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign#33-whatsapp-campaign).
   - For Microsoft Teams, choose the variable containing **Users contact details**, sender ID, and map the user variables used in the template same as [WhatsApp or Viber template](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign#34-viber-campaign).
...
8. **Schedule** your Campaign: Define when to send the campaign (Timezone: Asia/Kolkata). For detailed procedure, see [Schedule message](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign#4-schedule-message). From the options, select
...
9. In **Set a goal**, set the objective that you want to track for the campaign. For more details, see [Campaign goals](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign#6-campaign-goal).



i. Select and configure your desired goal - [Delivery](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign#1-delivery-goal), [Conversion](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign#2-conversion-goal) or [Response](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign#3-response-goal).
...
10. Use **Test Campaigns** to test it with internal team members before sending out actual audience. You can add up to five recipients. For a detailed procedure on how to test campaigns, see [Test campaign](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign#7-test-campaigns-recommended).
...
## 3\. Configure templates for different channels [​](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign\#3-configure-templates-for-different-channels "Direct link to 3. Configure templates for different channels")

This appears in the _Basic information_ screen once you select a channel template. You need to configure some settings depending on the channel and template. For example, setting up the sender ID, and mapping variables used in the template.

This section guides you on how to configure template for each channel -

### 3.1 SMS campaign [​](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign\#31-sms-campaign "Direct link to 3.1 SMS campaign")
...
### 3.2 Email campaign [​](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign\#32-email-campaign "Direct link to 3.2 Email campaign")
...
![](https://i.imgur.com/Y1h9Ui3.png)
2. In **Select the email address from which you want to send the campaign**, choose the email address from which you want to send the campaign. To know how to add email accounts, see [Email channel](https://docs.yellow.ai/docs/platform_concepts/channelConfiguration/email-outbound)
...
### 3.3 WhatsApp campaign [​](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign\#33-whatsapp-campaign "Direct link to 3.3 WhatsApp campaign")
...
5. To monitor URL clicks, select **URL click tracking** for variables that contain URLs.
![](https://i.imgur.com/QkqZcQr.png)
6. Use **Media** to configure personalized media for the campaign.
   ...
   - **Dynamic** media: Select this option to send personalized media to each user. Map the column from the database where you have included these details. For instance, you can send WhatsApp campaigns with personalized video media to your customers.
     ...
     a. [Create a user property](https://docs.yellow.ai/docs/platform_concepts/engagement/cdp/user_data/user_properties#custom-user-properties) with the data type set as URL.

     ![](https://i.imgur.com/l1CSdNF.png)

     b. [Store the image URL for each user to that user property](https://docs.yellow.ai/docs/platform_concepts/engagement/cdp/user_data/store_conv_data).

     c. Associate the media with this user property when scheduling the campaign.![](https://i.imgur.com/umvqXL4.png)

### 3.4 Viber campaign [​](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign\#34-viber-campaign "Direct link to 3.4 Viber campaign")
...
![](https://i.ibb.co/JFKy4x31/image.png)
2. In **Sender ID**, choose the WhatsApp business number from which you want to send the campaign.
![](https://i.imgur.com/sNtatZX.png)
3. In **Map variables**, associate each variable mentioned in the template with the user variables. You can map a variable or provide a bot link.
...
## 4\. Schedule message [​](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign\#4-schedule-message "Direct link to 4. Schedule message")
...
### 4.1 How many times you want to run the campaign [​](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign\#41-how-many-times-you-want-to-run-the-campaign "Direct link to 4.1 How many times you want to run the campaign")

Choose whether to run the campaign only once or on a recurring basis.

##### Run once [​](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign\#run-once "Direct link to Run once")
...
##### Run multiple times [​](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign\#run-multiple-times "Direct link to Run multiple times")
...
### 4.2 Business hours [​](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign\#42-business-hours "Direct link to 4.2 Business hours")
...
## 5\. Segments [​](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign\#5-segments "Direct link to 5. Segments")
...
## 6\. Campaign goal [​](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign\#6-campaign-goal "Direct link to 6. Campaign goal")
...
#### 1\. Delivery goal [​](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign\#1-delivery-goal "Direct link to 1. Delivery goal")
...
#### 2\. Conversion goal [​](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign\#2-conversion-goal "Direct link to 2. Conversion goal")
...
#### 3\. Response goal [​](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign\#3-response-goal "Direct link to 3. Response goal")
...
## 7\. Test campaigns (Recommended) [​](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign\#7-test-campaigns-recommended "Direct link to 7. Test campaigns (Recommended)")
...
#### Prerequisites for adding test user details [​](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign\#prerequisites-for-adding-test-user-details "Direct link to Prerequisites for adding test user details")

- Test users data should be available in the _User 360_ module
- Test users should have all the data which will be mapped to the variables used in the template.

#### Test campaign [​](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign\#test-campaign "Direct link to Test campaign")

1. Once you Schedule a campaign, you will see an option to Test campaign in Step 8 of [Create campaign](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign#2-create-outbound-campaign), Review and launch.
...
You will see the _Sending_ status. You can see the actual delivery status after a while (about 15 seconds) - Delivered or Failed.
...
## 8\. Campaign errors [​](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign\#8-campaign-errors "Direct link to 8. Campaign errors")
...
## 9\. Notifications on Campaign status & progress [​](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign\#9-notifications-on-campaign-status--progress "Direct link to 9. Notifications on Campaign status & progress")
...
![](https://i.imgur.com/jaGOOCM.png)
5. Click **Add**.


**What next**

- See how your campaign is performing using [Outbound campaign report](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/outbound-report).
...
- [1\. Prerequisites](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign#1-prerequisites)
- [2\. Create Outbound campaign](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign#2-create-outbound-campaign)
- [3\. Configure templates for different channels](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign#3-configure-templates-for-different-channels)
  - [3.1 SMS campaign](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign#31-sms-campaign)
  - [3.2 Email campaign](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign#32-email-campaign)
  - [3.3 WhatsApp campaign](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign#33-whatsapp-campaign)
  - [3.4 Viber campaign](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign#34-viber-campaign)
- [4\. Schedule message](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign#4-schedule-message)
  - [4.1 How many times you want to run the campaign](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign#41-how-many-times-you-want-to-run-the-campaign)
  - [4.2 Business hours](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign#42-business-hours)
- [5\. Segments](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign#5-segments)
- [6\. Campaign goal](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign#6-campaign-goal)
- [7\. Test campaigns (Recommended)](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign#7-test-campaigns-recommended)
- [8\. Campaign errors](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign#8-campaign-errors)
- [9\. Notifications on Campaign status & progress](https://docs.yellow.ai/docs/platform_concepts/engagement/outbound/outbound-campaigns/run-campaign#9-notifications-on-campaign-status--progress)

![Mia Support bot icon](https://cdn.yellowmessenger.com/PQuTgjPG7NxY1611996274269.png)
